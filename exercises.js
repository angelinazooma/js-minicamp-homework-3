...
function sumUserPostLikes(user) {
  ...
  for ( var i = 0; i < user.posts.length; i++) {
    newNum = newNum + user.posts[i].likes;
  }
...
function addCalculateDiscountPriceMethod(storeItem) {
  ...
  storeItem.calculateDiscountPrice = function() {
    var thisPrice = this.price;
    var thisDiscount = this.discountPercentage;
    var discountPrice = thisPrice - (thisPrice * thisDiscount);
    return discountPrice;
  };
  return storeItem;
 
  // use this to return the actual value instead of the object
